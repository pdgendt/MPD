...
struct CurlInputStream final : public AsyncInputStream, CurlResponseHandler {
	...
	void OnEnd() override;
	void OnError(std::exception_ptr e, CURLcode code = CURLE_OK) override;
...
void
CurlInputStream::OnError(std::exception_ptr e, CURLcode code)
{
